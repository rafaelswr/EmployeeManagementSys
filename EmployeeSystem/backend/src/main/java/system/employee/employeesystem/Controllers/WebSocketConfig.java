...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry){
        registry.enableSimpleBroker("/topic"); // Habilita um broker para envio de mensagens
        registry.setApplicationDestinationPrefixes("/app"); //mesnagens enviadas para o servidor
    }
